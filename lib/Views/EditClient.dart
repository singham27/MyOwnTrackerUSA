              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(child: Text('Billing address is same for \nservice address',
                          style: TextStylesProductSans.textStyles_14
                              .apply(color: ColorStyle.black, fontWeightDelta: 0))),
                      SwitchCustom(
                        onChanged: (value) {
                          print(value);
                          controller.isBillingServiceAddSame.value = !controller.isBillingServiceAddSame.value;
                          controller.billingServiceAddSame();
                        },
                      ),
                    ],
                  ),
