...
class EditClientController extends GetxController {
  ...
  RxBool isBillingServiceAddSame = false.obs;
  ...
  setValue() {
    ...
    addNotesController.value.text = modelClient.value.notes.toString();
  }
  ...
  void createClient() async {
    ...
    final params = {
      ...
      "notes": addNotesController.value.text
    };
  ...
  void updateClient() async {
    ...
    final response =
    await API.instance.post(endPoint: 'updateClient', params: params);
    print(response);
  ...
  void deleteClient(String clientID) async {
    ...
    final response =
    await API.instance.post(endPoint: 'deleteClient', params: params);
  ...
  billingServiceAddSame() {
    if (isBillingServiceAddSame.value) {
      serviceAddressController.value.text = addressController.value.text;
      serviceAddressSecController.value.text = addressSecController.value.text;
      serviceCityController.value.text = cityController.value.text;
      serviceStatePrivinceController.value.text = statePrivinceController.value.text;
      serviceZipPostelCodeController.value.text = zipPostelCodeController.value.text;
    } else {
      serviceAddressController.value.text = '';
      serviceAddressSecController.value.text = '';
      serviceCityController.value.text = '';
